...
const ProfileDataForm: React.FC<InjectedFormProps<ProfileType, PropsDataFormOwnType> & PropsDataFormOwnType> = ({
    profile,
    handleSubmit,
    error,
}) => {
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                {createField<ProfileDataKeysType>('My professional skills', 'lookingForAJobDescription', [], Textarea)}
            </div>
            <div>
